...
//diese parameter werden durch das script definiert
...
//TODO funktionen erstellen statt wiederholungen
if (isClass (missionConfigFile >> "CfgGRAD" >> "FireProp")) then {
  if (isNumber (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'TREERADIUS')) then {
    #define TREERADIUS  getNumber(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "TREERADIUS")
  };
  if (isNumber (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'MAKEFIRETIME')) then {
    #define MAKEFIRETIME  getNumber(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "MAKEFIRETIME")
  };
  if (isNumber (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'UPGRADEFIRETIME')) then {
    #define UPGRADEFIRETIME  getNumber(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "UPGRADEFIRETIME")
  };
  if (isNumber (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'ADDLEAVESTIME')) then {
    #define ADDLEAVESTIME  getNumber(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "ADDLEAVESTIME")
  };
  if (isNumber (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'FIREDISTANCETOPLAYER')) then {
    #define FIREDISTANCETOPLAYER  getNumber(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "FIREDISTANCETOPLAYER")
  };
  if (isNumber (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'BURNTIME_SMALLFIRE')) then {
    #define BURNTIME_SMALLFIRE  getNumber(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "BURNTIME_SMALLFIRE")
  };
  if (isNumber (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'BURNTIME_BIGFIRE')) then {
    #define BURNTIME_BIGFIRE  getNumber(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "BURNTIME_BIGFIRE")
  };
  if (isNumber (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'BURNTIME_LEAVES')) then {
    #define BURNTIME_LEAVES  getNumber(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "BURNTIME_LEAVES")
  };
  if (isText (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'CLASS_SMALLFIRE')) then {
    #define CLASS_SMALLFIRE  getText(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "CLASS_SMALLFIRE")
  };
  if (isText (missionconfigFile >> "CfgGRAD" >> "FireProp" >> 'CLASS_BIGFIRE')) then {
    #define CLASS_BIGFIRE  getText(missionConfigFile >> "CfgGRAD" >> "FireProp" >> "CLASS_BIGFIRE")
  };

} else {
  diag_log("no config");
};
//load default values for undef paramaters
#include "FIRE_DEFAULT_SETTINGS.hpp"
